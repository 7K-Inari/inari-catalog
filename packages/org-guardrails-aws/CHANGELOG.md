...
* org-guardrails-aws RGD (plan §5.12): multi-region CloudTrail and monthly
  budget alerts (80% forecasted / 100% actual) for vended accounts, filtered
  on the mandatory cost-center tag.
